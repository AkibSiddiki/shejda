                ...
                <table border="0" cellpadding="0" cellspacing="0" width="480">
                    <tr>
                        <td align="center" valign="top" style="padding: 40px 10px 40px 10px;">
                            <div style="display: block; font-family: Helvetica, Arial, sans-serif; color: #ffffff; font-size: 16px;" border="0"><img class="img-fluid" src="https://shejda.com/assets/web/image/bg/logo.png" alt="shejda.com" title="shejda.com" style=" width: 150px;"></div>
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="480">
                    <tr>
                        <td bgcolor="#ffffff" align="left" valign="top"
                            ...
                            <h1 style="font-size: 20px; font-weight: 400; margin: 0;">Message from {{ $name }}
                            </h1>
                        </td>
                    </tr>
                </table>
