    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title m-0 me-2">Edit Slider</h5>
                <div class="p-4">
                    <a href="{{ route('panel.slider.index') }}" class="btn btn-primary">List</a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <div class="mt-2">
                                    <img id="previewImage"
                                        src="{{ $slider->image ? asset($slider->image) : asset('assets/img/no-image.jpg') }}"
